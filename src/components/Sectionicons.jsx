  ...
  return (
    <div className="foot">
      <div className="ico-box">
        ...
        <a href="https://www.linkedin.com/company/ieeeggsipu/">
          <i class="fa-brands fa-4x fa-linkedin"></i>
        </a>
        <a href="https://m.facebook.com/706218599427060/">
          <i class="fa-brands fa-4x fa-facebook"></i>
        </a>
      </div>
